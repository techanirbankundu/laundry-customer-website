        ...
        if (response.ok) {
          ...
          <div class="max-w-3xl mx-auto py-20 px-4 text-center animate-fade-in">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
              <a href="../track-order/index.php?orderId=${result.order._id || result.order.id || result.order.orderNumber}" class="bg-sky-500 hover:bg-sky-600 text-white px-12 py-5 rounded-2xl font-black shadow-xl shadow-sky-500/20">TRACK ORDER</a>
