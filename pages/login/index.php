...
<section class="min-h-screen flex items-center py-12 bg-slate-50">
  <div class="container mx-auto px-6">
    <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden flex min-h-[500px]">
      <!-- Left Side: Branding -->
      <div class="hidden md:flex w-1/2 bg-gradient-to-br from-sky-500 to-indigo-600 p-12 flex-col justify-center text-white relative">
        ...
        <div class="relative z-10 text-center">
          <div class="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-6">
            <i class="fas fa-soap text-4xl"></i>
          </div>
          <h2 class="text-4xl font-bold mb-4">FreshSpin Laundry</h2>
          <p class="text-sky-100 text-lg leading-relaxed">Premium laundry services delivered right to your doorstep.</p>
        ...
        <form action="login_process.php" method="POST">
          ...
          <div class="flex justify-between items-center mb-6 text-sm">
            <label class="flex items-center gap-2 cursor-pointer text-gray-600 hover:text-gray-800">
              <input type="checkbox" class="w-4 h-4 text-sky-600 rounded focus:ring-sky-500 border-gray-300"> <span>Remember me</span>
            </label>
